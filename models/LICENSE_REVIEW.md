...
Reviewed: 2026-08-25. Machine-readable evidence and release decisions live in
...
| BRIA RMBG-1.4 | Disabled for production. The Hugging Face release is under a BRIA non-commercial model license, not a general permissive license. | https://huggingface.co/briaai/RMBG-1.4 |
| BiRefNet | Disabled for production until the selected weight and its training-data/model license are reviewed. Upstream explicitly notes that some third-party weights are non-commercial. | https://github.com/ZhengPeng7/BiRefNet |
